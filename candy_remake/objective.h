...
class Objective{
  ...
  string poss_objectives[3]={"Break->x->candies","Break->x->candies->color"}; // Vlad: More to be added later.
  ...
  Fl_Color colors[5]={FL_RED,FL_BLUE,FL_YELLOW,FL_DARK_CYAN,FL_GREEN};
